class CardAddress
  ...
  attr_accessor  :token, :postal, :prefecture_id, :city, :address, :building_name, :phone, :user_id, :item_id
  ...
  validates :phone, numericality: { only_integer: true, message: 'half-width characters' }
